...
Help()
{
   # Display Help
    ...
    echo "#         tas_prefix      : Should contain t_s as 2D variable                 #"
    echo "#         clt_prefix      : Should contain clct as 2D variable                #"
    echo "#         pr_prefix       : Should contain tot_prec_rate as 2D variable       #"
    echo "#         rlut_prefix     : Should contain thb_t as 2D variable               #"
    echo "#         uas_prefix      : Should contain u as 3D variable                   #"
    echo "#         vas_prefix      : Should contain v as 3D variable                   #"
    echo "#                                                                             #"
    echo "#         ua300hPa_prefix : Should contain u at all model levels              #"
    ...
    echo "#                                                                             #"
    echo "#         to_prefix       : Should contain to at all model levels             #"
    echo "#         so_prefix       : Should contain so at all model levels             #"
    echo "#                                                                             #"
    ...
    echo "#     Filenames of data files are constructed from the 'prefix' options       #"
